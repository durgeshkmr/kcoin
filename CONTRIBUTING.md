Contributing to KCOIN Core
============================

The KCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kcoin-project/kcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the KCOIN Core project, and is not to be
confused with overall KCOIN Network Protocol consensus changes.

Whether a pull request is merged into KCOIN Core rests with the project merge
...
Patches that change KCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the KCOIN consensus, it must have been
...
The project leader is the release manager for each KCOIN Core release.
