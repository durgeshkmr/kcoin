...
RESOURCES += src/qt/kcoin.qrc src/qt/kcoin_locale.qrc

TRANSLATIONS += src/qt/locale/kcoin_bg.ts \
                src/qt/locale/kcoin_de.ts \
                src/qt/locale/kcoin_en.ts \
                src/qt/locale/kcoin_es.ts \
                src/qt/locale/kcoin_fi.ts \
                src/qt/locale/kcoin_fr.ts \
                src/qt/locale/kcoin_it.ts \
                src/qt/locale/kcoin_ja.ts \
                src/qt/locale/kcoin_pl.ts \
                src/qt/locale/kcoin_pt.ts \
                src/qt/locale/kcoin_ru.ts \
                src/qt/locale/kcoin_sk.ts \
                src/qt/locale/kcoin_sv.ts \
                src/qt/locale/kcoin_vi.ts \
                src/qt/locale/kcoin_zh_CN.ts \
                src/qt/locale/kcoin_zh_TW.ts
