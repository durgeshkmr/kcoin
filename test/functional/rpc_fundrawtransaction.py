...
class RawTransactionsTest(KcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kcoin address" in e.error['message'])
