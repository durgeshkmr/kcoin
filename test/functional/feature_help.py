...
"""Verify that starting kcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import KcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kcoin with -h for help text")
        ...
        self.log.info("Start kcoin with -version for version information")
