...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KCOIN features */
        {"kcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"kcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"kcoin", "startmasternode", &startmasternode, true, true, false},
        {"kcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kcoin", "preparebudget", &preparebudget, true, true, false},
        {"kcoin", "submitbudget", &submitbudget, true, true, false},
        {"kcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"kcoin", "mnsync", &mnsync, true, true, false},
        {"kcoin", "spork", &spork, true, true, false},
        {"kcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzkcnseed", &getzkcnseed, false, false, true},
        {"zerocoin", "setzkcnseed", &setzkcnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkcn", &searchdzkcn, false, false, true},
        {"zerocoin", "dzkcnstate", &dzkcnstate, false, false, true},
...
{
    return "> kcoin-cli " + methodname + " " + args + "\n";
}
