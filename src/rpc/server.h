...
extern UniValue setzkcnseed(const UniValue& params, bool fHelp);
extern UniValue getzkcnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkcn(const UniValue& params, bool fHelp);
extern UniValue dzkcnstate(const UniValue& params, bool fHelp);
