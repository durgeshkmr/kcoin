...
// Copyright (c) 2016-2019 The KCOIN developers
...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 KCN
...
// KCOIN: on startup load spork values from previous session if they exist in the sporkDB
