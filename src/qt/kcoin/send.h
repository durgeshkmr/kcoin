...
#include "qt/kcoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(KCOINGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onKCNSelected(bool _isKCN);
    void onSendClicked();
...
private:
    ...
    bool sendZkcn(QList<SendCoinsRecipient> recipients);
