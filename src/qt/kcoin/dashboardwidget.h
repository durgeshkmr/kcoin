...
#include "config/kcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalKcn = 0;
    qint64 totalZkcn = 0;
    QList<qreal> valuesKcn;
    QList<qreal> valueszKcn;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(KCOINGUI* _window);
    ~DashboardWidget();
