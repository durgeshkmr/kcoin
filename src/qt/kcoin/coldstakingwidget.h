...
#include "qt/kcoin/furabstractlistitemdelegate.h"
#include "qt/kcoin/txviewholder.h"
#include "qt/kcoin/tooltipmenu.h"
#include "qt/kcoin/sendmultirow.h"
#include "qt/kcoin/coldstakingmodel.h"
#include "qt/kcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(KCOINGUI* parent);
    ~ColdStakingWidget();
