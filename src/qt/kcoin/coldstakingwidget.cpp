...
#include "qt/kcoin/coldstakingwidget.h"
#include "qt/kcoin/forms/ui_coldstakingwidget.h"
#include "qt/kcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/kcoin/requestdialog.h"
#include "qt/kcoin/tooltipmenu.h"
#include "qt/kcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(KCOINGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your KCNs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept KCN delegation / Delegate KCN"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select KCN outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 KCN" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
