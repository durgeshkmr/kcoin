...
#include "qt/kcoin/forms/ui_masternodeswidget.h"
#include "qt/kcoin/qtutils.h"
#include "qt/kcoin/mnrow.h"
#include "qt/kcoin/mninfodialog.h"

#include "qt/kcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(KCOINGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    if (verifyWalletUnlocked()) {
        if (walletModel->getBalance() <= (COIN * 10000)) {
            inform(tr("Not enough balance to create a masternode, 10,000 KCN required."));
            return;
        }
        showHideOp(true);
