...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, KCOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, KCOINGUI *gui, double posX = 3);
