...
#include "qt/kcoin/settings/settingssignmessagewidgets.h"
#include "qt/kcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(KCOINGUI* _window, QWidget *parent) :
