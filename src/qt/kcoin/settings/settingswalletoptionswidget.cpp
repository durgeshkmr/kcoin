...
#include "qt/kcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/kcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(KCOINGUI* _window, QWidget *parent) :
