...
#include "qt/kcoin/settings/forms/ui_settingswidget.h"
#include "qt/kcoin/settings/settingsbackupwallet.h"
#include "qt/kcoin/settings/settingsbittoolwidget.h"
#include "qt/kcoin/settings/settingswalletrepairwidget.h"
#include "qt/kcoin/settings/settingswalletoptionswidget.h"
#include "qt/kcoin/settings/settingsmainoptionswidget.h"
#include "qt/kcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/kcoin/settings/settingsmultisendwidget.h"
#include "qt/kcoin/settings/settingsinformationwidget.h"
#include "qt/kcoin/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(KCOINGUI* parent) :
    PWidget(parent),
