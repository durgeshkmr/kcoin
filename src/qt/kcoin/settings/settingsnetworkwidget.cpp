...
#include "qt/kcoin/settings/settingsnetworkwidget.h"
#include "qt/kcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/kcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KCOINGUI* _window, QWidget *parent) :
