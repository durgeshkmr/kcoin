...
#include "qt/kcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/kcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(KCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to KCOINGUI::handleRestart()
