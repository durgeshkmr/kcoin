...
#include "qt/kcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/kcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(KCOINGUI* _window, QWidget *parent) :
