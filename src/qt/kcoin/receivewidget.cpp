...
#include "qt/kcoin/forms/ui_receivewidget.h"
...
#include "qt/kcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(KCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive KCN."));
