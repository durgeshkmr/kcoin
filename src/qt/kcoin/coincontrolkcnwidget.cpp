...
#include "qt/kcoin/coincontrolkcnwidget.h"
#include "qt/kcoin/forms/ui_coincontrolkcnwidget.h"

CoinControlKcnWidget::CoinControlKcnWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlKcnWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select KCN Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("KCN");
    ...
    ui->labelValueAfter->setText("0.00 KCN");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 KCN");
    ui->labelValueFee->setText("0.00 KCN");
...
CoinControlKcnWidget::~CoinControlKcnWidget()
{
    delete ui;
}
