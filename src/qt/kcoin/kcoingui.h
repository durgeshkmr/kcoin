...
#ifndef KCOIN_CORE_NEW_GUI_KCOINGUI_H
#define KCOIN_CORE_NEW_GUI_KCOINGUI_H
...
/**
  KCOIN GUI main class. This class represents the main window of the KCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KCOINGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~KCOINGUI();
...
#endif //KCOIN_CORE_NEW_GUI_KCOINGUI_H
