...
#ifndef KCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define KCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //KCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
