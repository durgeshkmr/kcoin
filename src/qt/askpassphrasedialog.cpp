...
#include "qt/kcoin/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR KCN</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                KCOINGUI* window = static_cast<KCOINGUI*>(parentWidget());
...
{
    KCOINGUI* gui = static_cast<KCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<KCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("KCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your KCNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
