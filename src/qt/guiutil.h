...
// Render KCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZkcn = false);
...
// Parse "kcoin:" URI into recipient object, return true on successful parsing
