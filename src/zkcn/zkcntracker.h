...
#ifndef KCOIN_ZKCNTRACKER_H
#define KCOIN_ZKCNTRACKER_H
...
public:
    CzKCNTracker(std::string strWalletFile);
    ~CzKCNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzKCNWallet* zKCNWallet = NULL);
