...
#ifndef KCOIN_LEGACY_ZPOS_H
#define KCOIN_LEGACY_ZPOS_H
...
class CLegacyZKcnStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    explicit CLegacyZKcnStake(const libzerocoin::CoinSpend& spend);
    bool IsZKCN() const override { return true; }
