// Copyright (c) 2017-2018 The KCOIN developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef KCOIN_ZKCNWALLET_H
#define KCOIN_ZKCNWALLET_H
...
public:
    CzKCNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZKCN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZKCN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
